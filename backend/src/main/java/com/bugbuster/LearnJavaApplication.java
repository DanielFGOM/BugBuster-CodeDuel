    ...
    public CommandLineRunner initData(LevelRepository levelRepository) {
        return args -> {
            if (levelRepository.count() == 0) {
                ...
                // CORRECCIÓN NIVEL 8: LLAMADA A MÉTODO
                save(levelRepository, 8, "Llamada a Método", "Crea un método llamado 'saludar()' que imprima 'Hola Mundo' y llámalo desde el main.", "public class LlamadaAMetodo {\n    public static void main(String[] args) {\n        // Escribe tu código aquí\n    }\n}", "Hola Mundo", "Los métodos permiten encapsular código para reutilizarlo. Se definen fuera del main y se llaman dentro.");
                ...
                // ==================================================================================
                // MÓDULO 2: FLUJO DE CONTROL (13-25)
                // ==================================================================================
                ...
                save(levelRepository, 23, "Operadores AND", "Si x=5 Y y=10, imprime 'Ambos'.", "public class OperadoresAnd {\n    public static void main(String[] args) {\n        int x = 5, y = 10;\n        // Escribe tu código aquí\n    }\n}", "Ambos", "El operador && requiere que AMBAS condiciones sean verdaderas.");
                save(levelRepository, 24, "Operadores OR", "Si x=5 O y=0, imprime 'Uno'.", "public class OperadoresOr {\n    public static void main(String[] args) {\n        int x = 5, y = 0;\n        // Escribe tu código aquí\n    }\n}", "Uno", "El operador || es verdadero si AL MENOS UNA condición se cumple.");
                ...
                // ==================================================================================
                // MÓDULO 3: ESTRUCTURAS DE DATOS (26-35)
                // ==================================================================================
                ...
                save(levelRepository, 50, "Proyecto Final", "Suma dos números usando una clase Calculadora.", "public class ProyectoFinal {\n    public static void main(String[] args) {\n        // Escribe tu código aquí\n    }\n}", "100", "Sintetiza todo lo aprendido.");
