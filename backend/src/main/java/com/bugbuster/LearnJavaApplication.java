    ...
    public CommandLineRunner initData(LevelRepository levelRepository) {
        return args -> {
            if (levelRepository.count() == 0) {
                ...
                // ==================================================================================
                // MÓDULO 1: FUNDAMENTOS DE SINTAXIS (1-12)
                // Objetivo: Entender la estructura de Java, tipos de datos y salida de consola.
                // ==================================================================================
                save(levelRepository, 1, "Hola Mundo", "Usa System.out.println() para imprimir exactamente: Hola Mundo", 
                    "public class Main {\n    public static void main(String[] args) {\n        // Aquí escribe tu código\n    }\n}", "Hola Mundo", "println() es la instrucción básica para enviar texto a la consola.");
                ...
                save(levelRepository, 3, "Cadenas de Texto", "Crea un String 'nombre' con tu nombre e imprímelo.", 
                ...
                save(levelRepository, 5, "Operaciones Básicas", "Suma 10 + 5 y muestra el resultado.", 
                ...
                // ==================================================================================
                // MÓDULO 2: LÓGICA Y CONTROL (13-25)
                // Objetivo: Tomar decisiones y repetir tareas.
                // ==================================================================================
                ...
                save(// Sigue la misma lógica para el resto...
                levelRepository, 15, "Else-If", "Si n=10 imprime 'Diez', si n=5 'Cinco', sino 'Otro'.", 
                ...
                save(//Lógica de control avanzada
                levelRepository, 19, "Do-While", "Imprime 'Hola' una sola vez usando do-while.", 
                ...
                // ==================================================================================
                // MÓDULO 3: ESTRUCTURAS DE DATOS (26-38)
                // ==================================================================================
                ...
                save(levelRepository, 34, "Métodos de String", "Convierte 'java' a mayúsculas e imprímelo.", 
                    "public class Main {\n    public static void main(String[] args) {\n        String s = \"java\";\n        // Aquí escribe tu código\n    }\n}", "JAVA", "La clase String tiene métodos útiles como .toUpperCase() y .toLowerCase().");
                ...
                // ==================================================================================
                // MÓDULO 4: PROGRAMACIÓN ORIENTADA A OBJETOS - OOP (36-50)
                // ==================================================================================
                save(levelRepository, 36, "Crear Clase", "Crea la clase 'Persona' con un atributo 'nombre' y muéstralo.", 
                    "public class Main {\n    public static void main(String[] args) {\n        // Aquí escribe tu código\n    }\n}", "Juan", "Una clase es un molde para crear objetos con atributos y comportamientos.");
                
                save(levelRepository, 37, "Instanciar Objetos", "Crea un objeto de la clase 'Coche' e imprime su marca.", 
                    "public class Main {\n    public static void main(String[] args) {\n        // Aquí escribe tu código\n    }\n}", "Toyota", "Instanciar es crear un objeto real a partir de una clase usando la palabra 'new'.");
                ...
                save(levelRepository, 40, "Getters y Setters", "Usa un setter para cambiar la edad de un 'Jugador' a 20.", 
                    "public class Main {\n    public static void main(String[] args) {\n        // Aquí escribe tu código\n    }\n}", "20", "El encapsulamiento protege los datos usando métodos públicos para acceder a variables privadas.");
                ...
                save(levelRepository, 44, "Polimorfismo", "Crea una lista de 'Animales' con Perros y Gatos e imprime sus sonidos.", 
                    "public class Main {\n    public static void main(String[] args) {\n        // Aquí escribe tu código\n    }\n}", "Guau\nMiau", "El polimorfismo permite tratar objetos de diferentes clases como si fueran de la misma clase padre.");
                ...
                save(levelRepository, 47, "Manejo de Excepciones", "Usa try-catch para capturar una división por cero.", 
                    "public class Main {\n    public static void main(String[] args) {\n        // Aquí escribe tu código\n    }\n}", "Error", "Try-catch evita que el programa se cierre inesperadamente ante un error.");
                ...
                save(levelRepository, 50, "Proyecto Final", "Crea un sistema simple que sume dos números usando una clase Calculadora.", 
                    "public class Main {\n    public static void main(String[] args) {\n        // Aquí escribe tu código\n    }\n}", "100", "Sintetiza todo lo aprendido: Clases, Métodos y Operaciones.");

                System.out.println("🚀 PostgreSQL: 50 niveles cargados con éxito. Ruta de aprendizaje completa.");
            }
        };
    }
